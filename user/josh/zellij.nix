  ...
  xdg.configFile."zellij/layouts/helix.kdl".text = toKDL { } [
    (nodeCh "layout" [
      (kdlNode "tab" [ ] { hide_floating_panes = true; } [
        (pane { command = "hx"; close_on_exit = true; borderless = true; } [ ])
    ...
    [
      ...
      (nodeCh "keybindings" [
        ...
        (nodeCh "pane" [
          ...
          (bind "n" [ (node0 "NewPane") (node1 "SwitchToMode" "Normal") ])
          (bind "d" [ (node1 "NewPane" "Down") (node1 "SwitchToMode" "Normal") ])
          (bind "r" [ (node1 "NewPane" "Right") (node1 "SwitchToMode" "Normal") ])
          (bind "x" [ (node0 "CloseFocus") (node1 "SwitchToMode" "Normal") ])
          (bind "f" [ (node0 "ToggleFocusFullscreen") (node1 "SwitchToMode" "Normal") ])
          (bind "z" [ (node0 "TogglePaneFrames") (node1 "SwitchToMode" "Normal") ])
          (bind "w" [ (node0 "ToggleFloatingPanes") (node1 "SwitchToMode" "Normal") ])
          (bind "e" [ (node0 "TogglePaneEmbedOrFloating") (node1 "SwitchToMode" "Normal") ])
          (bind "c" [ (node1 "SwitchToMode" "RenamePane") (node1 "PaneNameInput" 0) ])
        ])
        (nodeCh "move" [
        ...
        (nodeCh "tab" [
          ...
          (bind "r" [ (node1 "SwitchToMode" "RenameTab") (node1 "TabNameInput" 0) ])
          (bind [ "h" "Left" "Up" "k" ] (node0 "GoToPreviousTab"))
          (bind [ "l" "Right" "Down" "j" ] (node0 "GoToNextTab"))
          (bind "n" [ (node0 "NewTab") (node1 "SwitchToMode" "Normal") ])
          (bind "x" [ (node0 "CloseTab") (node1 "SwitchToMode" "Normal") ])
          (bind "s" [ (node0 "ToggleActiveSyncTab") (node1 "SwitchToMode" "Normal") ])
          (bind "b" [ (node0 "BreakPane") (node1 "SwitchToMode" "Normal") ])
          (bind "]" [ (node0 "BreakPaneRight") (node1 "SwitchToMode" "Normal") ])
          (bind "[" [ (node0 "BreakPaneLeft") (node1 "SwitchToMode" "Normal") ])
          (bind "1" [ (node1 "GoToTab" 1) (node1 "SwitchToMode" "Normal") ])
          (bind "2" [ (node1 "GoToTab" 2) (node1 "SwitchToMode" "Normal") ])
          (bind "3" [ (node1 "GoToTab" 3) (node1 "SwitchToMode" "Normal") ])
          (bind "4" [ (node1 "GoToTab" 4) (node1 "SwitchToMode" "Normal") ])
          (bind "5" [ (node1 "GoToTab" 5) (node1 "SwitchToMode" "Normal") ])
          (bind "6" [ (node1 "GoToTab" 6) (node1 "SwitchToMode" "Normal") ])
          (bind "7" [ (node1 "GoToTab" 7) (node1 "SwitchToMode" "Normal") ])
          (bind "8" [ (node1 "GoToTab" 8) (node1 "SwitchToMode" "Normal") ])
          (bind "9" [ (node1 "GoToTab" 9) (node1 "SwitchToMode" "Normal") ])
        ...
        (nodeCh "renamepane" [
          (bind "Ctrl c" (node1 "SwitchToMode" "Normal"))
          (bind "Esc" [ (node0 "UndoRenamePane") (node1 "SwitchToMode" "Pane") ])
        ])
        (nodeCh "session" [
